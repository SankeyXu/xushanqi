				...
				<div id="swipebox-container">
					...
					<div id="swipebox-bottom-bar">
						<div id="swipebox-arrows">
							<a id="swipebox-prev" class="glyphicon glyphicon-chevron-left"></a>
							<a id="swipebox-next" class="glyphicon glyphicon-chevron-right"></a>
						</div>
					</div>
					<a id="swipebox-close" class="glyphicon glyphicon-remove"></a>
				</div>
			</div>`;
